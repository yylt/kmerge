...
{{/*
Expand the name of kmerge .
*/}}
{{- define "kmerge.name" -}}
{{- default "kmerge" .Values.global.nameOverride | trunc 63 | trimSuffix "-" }}
{{- end }}

{{/*
Common labels
*/}}
{{- define "kmerge.Controller.labels" -}}
helm.sh/chart: {{ include "kmerge.chart" . }}
{{ include "kmerge.Controller.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
*/}}
{{- define "kmerge.Controller.selectorLabels" -}}
app.kubernetes.io/name: {{ include "kmerge.name" . }}
...
*/}}
{{- define "kmerge.Controller.image" -}}
...
{{- define "generate-ca-certs" }}
    {{- $ca := genCA "kmerge.io" (.Values.controller.tls.auto.caExpiration | int) -}}
    {{- $_ := set . "ca" $ca -}}
{{- end }}
